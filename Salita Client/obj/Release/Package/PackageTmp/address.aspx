...
<div class="container">
     ...
     <legend class="blackclear whitetext">Transportación para a <asp:Label ID="lblFullName" runat="server" style="text-transform:uppercase;"></asp:Label></legend>
     ...
     <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator" Visible="false"></asp:CustomValidator>
        ...
        <div class="form-group">
         ...
         <div class="buttonpanel">
             <asp:LinkButton ID="cmdSeatInRoom" runat="server" CssClass="btn mybutton blue rounded shadow whitetext"><asp:Image runat="server" ImageUrl="~/images/check.png" /><span>Someter</span></asp:LinkButton>
             <asp:LinkButton ID="cmdCancel" runat="server" CssClass="btn mybutton black rounded shadow whitetext" ><asp:Image runat="server" ImageUrl="~/images/return.png" /><span>Volver</span></asp:LinkButton>
         </div>
